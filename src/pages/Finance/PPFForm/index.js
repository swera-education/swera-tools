...
export default class Finance extends Component {
  ...
  submitForm = values => {
    ...
    setTimeout(() => {
      document.getElementById('ppfResult').scrollIntoView({behavior: 'smooth', block: "end"})
    }, 100);
    return null;
  }
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-8">
            <PPFForm onSubmit={this.submitForm} />
          </div>
        </div>
        <div className = "row" id="ppfResult">
          <div className="col-md-8" >
