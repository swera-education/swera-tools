...
export default class Finance extends Component {
  ...
  submitForm = values => {
    ...
    setTimeout(() => {
      document.getElementById('sipResult').scrollIntoView({behavior: 'smooth', block: "end"})
    }, 100);
    return null;
  }
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-8">
            <SIPForm onSubmit={this.submitForm} />
          </div>
        </div>
        <div className = "row" id="sipResult">
          <div className="col-md-8" >
