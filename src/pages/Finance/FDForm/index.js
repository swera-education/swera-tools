...
export default class Finance extends Component {
  ...
  submitForm = values => {
    ...
    setTimeout(() => {
      document.getElementById('fdResult').scrollIntoView({behavior: 'smooth', block: "end"})
    }, 100);
    return null;
  }
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-8">
            <FDForm onSubmit={this.submitForm} />
          </div>
        </div>
        <div className = "row" id="fdResult">
          <div className="col-md-8" >
